...
export const equalPlanQueryDiffFixture: QueryDiff = {
  ...
  operator_diffs: [
    {
      operators: [
        { label: 'Scan orders', operator_type_name: 'Scan', count: 1 },
        { label: 'Scan orders', operator_type_name: 'Scan', count: 1 },
      ],
      stats: {
    ...
    {
      operators: [
        { label: 'Join lineitem', operator_type_name: 'Join', count: 1 },
        { label: 'Join lineitem', operator_type_name: 'Join', count: 1 },
      ],
      stats: {
    ...
    {
      operators: [
        { label: 'Aggregate', operator_type_name: 'Aggregate', count: 1 },
        { label: 'Aggregate', operator_type_name: 'Aggregate', count: 1 },
      ],
      stats: {
