...
function RuntimeNumberComparisonCard({
  ...
  const displayedDelta = toDisplayDelta(comparison.delta);
  return (
    <NumberComparisonCard
      ...
      percentDelta={toDisplayPercentDelta(comparison.percentDelta)}
  ...
  return comparisons.map(comparison => ({
    ...
    bars: [
      ...
      },
      {
        ...
        deltaValue: toDisplayDelta(comparison.delta),
        percentDelta: toDisplayPercentDelta(comparison.percentDelta),
      },
    ],
  }));
  ...
  for (const comparison of comparisons) {
    ...
    for (const operatorComparison of operatorComparisons) {
      ...
      row.comparisonBars.push({
        ...
        deltaValue: toDisplayDelta(operatorComparison.delta),
        percentDelta: toDisplayPercentDelta(operatorComparison.percentDelta),
      });
