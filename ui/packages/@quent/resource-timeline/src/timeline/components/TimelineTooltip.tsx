...
import { formatDurationForWindow, formatDuration, cn } from '@quent/utils';
import { DataText } from './DataText';
import type { TimelineAttribute } from '@quent/viz-timeline';
...
export interface ActiveMark {
  ...
  derivedAttributes?: TimelineAttribute[];
      ...
      {marks.map((m, i) => (
        <div key={i}>
          ...
          {m.attributes?.map(attr => (
            <MarkDetailRow key={attr.key} name={attr.key} value={attr.value} />
          ))}
