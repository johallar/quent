    ...
    renderWithMarks([
      {
        ...
        durationMs: 750,
        attributes: [
          { key: 'input_bytes', value: '1.40 GiB' },
          { key: 'current_operator_id', value: '11' },
        ],
        derivedAttributes: [{ key: 'bytes_per_sec', value: '2.00 GB/s' }],
      },
    ]);
    ...
    renderWithMarks([
      {
        ...
        derivedAttributes: [
          {
            key: 'pipeline',
            value: 'GPU_SCAN(11) -> PROJECTION(6) -> HASH_GROUP_BY(8)',
          },
        ],
      },
    ]);
