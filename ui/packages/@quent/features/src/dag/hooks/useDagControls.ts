...
import type { DAGEdge, NodeColoring, EdgeWidthConfig } from '../state/types';
import type { EdgeColoring } from '../state/types';
import { useMemo, useEffect } from 'react';
import { useAtomValue, useSetAtom } from 'jotai';
import type { DAGNode } from '../state/types';
...
import {
  ...
  edgeColoringAtom,
} from '../state/dagControls';

// Computation functions injected to avoid circular dep with @quent/features
