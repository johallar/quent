...
// Keep raw atoms private; consumers use DAG selectors.

import type { EdgeColoring, NodeLabelField } from './types';
import type { StatValue } from '@quent/protocol';
import type { EdgeWidthConfig, DagLayoutDirection } from './types';
import { atom } from 'jotai';
import type { NodeColoring } from './types';
import { NODE_LABEL_FIELD } from './types';
import { DAG_LAYOUT_DIRECTION } from './types';
 ...
 * here so DAG state and rendering share one canonical contract.
