...
import { createDataFlowStateColorFn } from '@quent/protocol';
import { memo, useMemo } from 'react';
import { createCapacitiesColorFn, type PaletteTheme } from '@quent/utils';
import { useDataFlowFrame, useDataFlowMeta } from '../../dag/data-flow/dataFlowSelectors';
import {
  fitDataFlowSegmentLabel,
  formatDataFlowValueCompact,
} from '../../dag/data-flow/dataFlow.utils';
import { NODE_LAYOUT_WIDTH } from '../../dag/components/layout';
