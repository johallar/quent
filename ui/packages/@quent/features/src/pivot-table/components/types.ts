...
import type { AggMode } from '../state/pivotTable';
import type { HoveredStatInfo } from '../../dag/state/dagControls';

// Re-exports of pivot-table-related types that originate in @quent/features but
// are commonly imported alongside the table-specific types defined below.
export type { AggMode } from '../state/pivotTable';
export type { HoveredStatInfo } from '../../dag/state/dagControls';
