...
import { MIN_ZOOM_WINDOW_S, useZoomRange } from '@quent/resource-timeline';
import { HiddenScroll } from '../shared/ui/thin-scroll';
import { useSelectedNodeIds, useSetSelectedNodeIds } from '../dag/hooks/useSelectedNodeIds';
import { useSetSelectedOperatorLabel } from '../dag/hooks/useSelectedOperatorLabel';
import { useSetSelectedPlanId } from '../dag/hooks/useSelectedPlanId';
import {
...
export function OperatorGanttChart({
  ...
  const attachWheelNavigation = useTimelineWheelNavigation(minZoomSpanPct, TIMELINE_SPACING);
