...
const GRID_INSETS = { left: 0, right: 10 };
...
describe('useTimelineWheelNavigation', () => {
  it('pans the visible range on horizontal wheel input', () => {
    ...
    const { result } = renderHook(() => useTimelineWheelNavigation(10, GRID_INSETS));
    ...
    const spanPct = 50;
    const usableWidth = CHART_WIDTH - GRID_INSETS.left - GRID_INSETS.right;
